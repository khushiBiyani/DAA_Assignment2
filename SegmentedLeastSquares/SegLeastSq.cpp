...
double c;       /*cost*/
int nLines=0; /* to count number of segments */
...
int main()
{
    ...
    ofstream file("TimevsC.csv", ios::app);
    file << time << "," << c << "\n";
    file.close();
    ofstream file1("TimevsN.csv", ios::app);
    file1 << time << "," << nPoints << "\n";
    file1.close();
    ofstream file2("TimevsNoOfLine.csv", ios::app);
    file2 << time << "," << nLines<< "\n";
    file2.close();
    ofstream file3("NoOfLinevsC.csv", ios::app);
    file3 << nLines << "," << nPoints << "\n";
    file3.close();
    return 0;
